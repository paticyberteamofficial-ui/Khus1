...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='author' content='bahauddin'/>
		<meta name='created by' content='bahauddin pati cyber team'/>
  ...
  <body class="text-white">
    <div class="p-3">
    	...
    	<hr>
    	<center>
    		<small>Created by &copy; <a href="https://www.tutorialbahauddinstyle.my.id/">Bahauddin</a></small>
    	</center>
    </div>
...
if($ext == "php") {
		...
		echo '<center><small>Created by '.date('M-Y').' <a href="https://www.tutorialbahauddinstyle.my.id/">Bahauddin</a></small></center>';
?>
